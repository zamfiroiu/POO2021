...
//		if (this != &cc) {
//			if (this->sucuri != NULL) {
//				for (int i = 0;i < this->nrSucuri;i++) {
//					if (this->sucuri[i]) {
//						delete[]this->sucuri[i];
//					}
//				}
//				delete[]this->sucuri;
//			}
...
//
//	cout << *(cd.sucuri[0]) << endl;
//	cout << *(cd.sucuri[1]) << endl;
//	SucNatural* suc = static_cast<SucNatural*>(cd.sucuri[1]);
//	cout << *suc;
//
//}
