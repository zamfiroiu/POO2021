...
//void main() {
//
//	//fstream fis("fisier1042.bin", ios::out | ios::binary);
//	//Carte c("Eminescu", 234, "Poezii", 27, "167", 2, new string[2]{ "Introducere","Bibliografie" });
//	
//	//c.scriereFisierBinar(fis);
//
//	//fis.close();
//
//	fstream f("fisier1042.bin", ios::in | ios::binary);
//	Carte c;
//
//	c.citesteFisierBinar(f);
//
//	f.close();
//	cout << c;
//}