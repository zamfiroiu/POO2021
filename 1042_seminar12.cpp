...
//using namespace std;
//
//class CarteAbstracta {
//	char* tematica;
//public:
//	CarteAbstracta() {
//		tematica = new char[strlen("SF") + 1];
//		strcpy(tematica, "SF");
//	}
//	CarteAbstracta(const char* tematica) {
//		this->tematica = new char[strlen(tematica) + 1];
//		strcpy(this->tematica, tematica);
//	}
//	CarteAbstracta(const CarteAbstracta& c) {
//		this->tematica = new char[strlen(c.tematica) + 1];
//		strcpy(this->tematica, c.tematica);
//	}
//	CarteAbstracta& operator=(const CarteAbstracta& c) {
//		
//		if (this != &c)
//		{
//			if (this->tematica) {
//				delete this->tematica;
//			}
//			this->tematica = new char[strlen(c.tematica) + 1];
//			strcpy(this->tematica, c.tematica);
//			return *this;
...
//	}
//
//	virtual ~CarteAbstracta() {
//		if (this->tematica) {
//			delete this->tematica;
//		}
//	}
//	virtual void printeazaDescrire() = 0;
//
//};
//
//
//class Carte: public CarteAbstracta {
//private:
//	char* autor;
//	int nrPagini;
//	string titlu;
...
//	string* capitole;
//public:
//	Carte() :CarteAbstracta(),ISBN("1234") {
//		nrCarti++;
//		//autor = NULL;
...
//	}
//
//	Carte(const char* autor, int nrPagini, string titlu, float pret, string newISBN, int nrCapitole, string* capitole) : CarteAbstracta("Actiune"), ISBN(newISBN) {
...
//	}
//
//	Carte(const Carte& c) :CarteAbstracta(c), ISBN(c.ISBN) {
//		if (c.autor != NULL) {
...
//	}
//
//	virtual void printeazaDescrire() {
...
//			this->carti[i]->printeazaDescrire();
//		}
//	}
//
//};
...
//	tip atribut;
//public:
//	ClasaTemplate(int nr,tip param) {
//		this->numar = nr;
//		this->atribut = param;
//	}
//	tip getAtribut() {
...
//void main() {
//	//CarteAbstracta *ca;
//	//ca = new Carte("Autor", 200, "Titlu", 20, "ISBN1234", 2, new string[2]{ "cap1","cap2" });
//	//ca->printeazaDescrire();
//	//delete ca;
//	//ca = new CartePentruCopii(true, 12, 2, new string[2]{ "pers1","pers2" });
//	//ca->printeazaDescrire();
//	//delete ca;
//
//	int a = 5;
...
//
//	ClasaTemplate<int> obiectTemplate(5,8);
//	ClasaTemplate<Carte> obiectCarte(5, c2);
//	cout << obiectCarte.getAtribut();
//}