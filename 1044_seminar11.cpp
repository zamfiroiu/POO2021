...
//
//	int nrCafenele = 3;
//	Cafenea** cafenele = new Cafenea * [nrCafenele];
//	cafenele[0] = new Cafenea("5togo", 3, new float[3]{ 5,10,15 }, 2020);//heap
//	cafenele[1] = new CafeneaCuPrajituri(2, new Tip[2]{ vegan,Vegetarian }, new float[2]{ 20,25 });//heap
//	Cafenea c("5togo", 3, new float[3]{ 5,10,15 }, 2020);
//	cafenele[2] = &c;//stack
//
//	Mall mall(nrCafenele, cafenele, "MallDova");
//
//	mall.prezentareCafenele();
//
//
//
//
